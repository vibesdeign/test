...
　%0D%0A
・強化ガラスケース：'.array_sum($_SESSION['num_array_glship']).'%0D%0A
　%0D%0A
・グリップケース：'.array_sum($_SESSION['num_array_grphip']).'%0D%0A
　%0D%0A
...
print '
<a style="display:block;width:15em;padding:0.5em 0;margin:2em 0;background:#f33;color:#fff;text-align:center;text-decoration:none;font-size:1.5em;border-radius:5px;" href="mailto:'.$mailto.'?cc='.$cc.'&subject='.$subject.'&body='.$body.'" target="_blank">メール作成</a>
<hr>
...
　<br>
・強化ガラスケース：'.array_sum($_SESSION['num_array_glship']).'<br>
　<br>
・グリップケース：'.array_sum($_SESSION['num_array_grphip']).'<br>
　<br>
